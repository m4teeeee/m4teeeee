...
**Herramientas de Seg. Informática**  
![Nmap](https://img.shields.io/badge/Nmap-202324?style=for-the-badge)
![Metasploit](https://img.shields.io/badge/Metasploit-000000?style=for-the-badge)
![Burp Suite](https://img.shields.io/badge/Burp_Suite-FF6633?style=for-the-badge)
![Wireshark](https://img.shields.io/badge/Wireshark-1679A7?style=for-the-badge&logo=wireshark&logoColor=white)

**Redes y Admin. de Sistemas**  
`TCP/IP` `Switching` `Config. de Proxies` `Config. SSH Server`

**Control de Versiones**  
![Git](https://img.shields.io/badge/Git-F05032?style=for-the-badge&logo=git&logoColor=white)

**Comprensión de Protocolos de Red Clave**  
`TCP/IP` `HTTP/S` `DNS` `DHCP` `SMB`

**Conocimientos de Conceptos de Seguridad de Red Clave**  
`Firewalls` `IDS/IPS` `VPNs`

**Familiaridad con Marcos y Metodologías**  
`NIST` `ISO27000` `NIST CSF` `OWASP Top 10` `PTES` `OSINT` `SMART`

**Idiomas**  
`Español (Nativo)` `Inglés (B2 First Certificate - FCE)`
